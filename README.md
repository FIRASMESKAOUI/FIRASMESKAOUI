...
### 📊 Atlas View
Advanced BVMT charting platform with interactive UI, candlestick visualization, and technical analysis tools. Built with **React + TypeScript + PostgreSQL**

<br/>

### 💬 Foxy Chat
Real-time messaging system with low-latency communication and scalable architecture. Built with **React + TypeScript + PostgreSQL**
